...
<header class="lnet-site-header">
	<div class="lnet-wrap lnet-header-inner">
		<a class="lnet-brand lnet-header-brand" href="<?php echo esc_url( home_url( '/' ) ); ?>" aria-label="<?php echo esc_attr__( 'Limbe.Net home', 'limbenet-coastwave' ); ?>">
			<img class="lnet-brand-logo" src="<?php echo esc_url( get_template_directory_uri() . '/assets/images/site-logo.png' ); ?>" alt="<?php echo esc_attr__( 'Limbe.Net', 'limbenet-coastwave' ); ?>" width="1425" height="570" decoding="async">
		</a>
