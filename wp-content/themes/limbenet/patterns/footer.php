...
<footer class="lnet-site-footer">
	<div class="lnet-wrap">
		<div class="lnet-footer-grid">
			...
			<div>
				<div class="lnet-footer-title"><?php echo esc_html__( 'Company Information', 'limbenet' ); ?></div>
				<div class="lnet-footer-links">
					<a href="<?php echo esc_url( home_url( '/about-us/' ) ); ?>"><?php echo esc_html__( 'About Us', 'limbenet' ); ?></a>
					<a href="<?php echo esc_url( home_url( '/contact-us/' ) ); ?>"><?php echo esc_html__( 'Contact Us', 'limbenet' ); ?></a>
					<a href="<?php echo esc_url( home_url( '/terms-and-conditions/' ) ); ?>"><?php echo esc_html__( 'Terms & Conditions', 'limbenet' ); ?></a>
					<a href="<?php echo esc_url( home_url( '/privacy-policy/' ) ); ?>"><?php echo esc_html__( 'Privacy Policy', 'limbenet' ); ?></a>
					<a href="<?php echo esc_url( home_url( '/cookie-policy/' ) ); ?>"><?php echo esc_html__( 'Cookie Policy', 'limbenet' ); ?></a>
				</div>
			</div>
		</div>
