...
function limbenet_setup() {
	load_theme_textdomain( 'limbenet', get_template_directory() . '/languages' );
	...
	register_nav_menus(
		array(
			'primary' => __( 'Primary Navigation', 'limbenet' ),
			'footer'  => __( 'Footer Navigation', 'limbenet' ),
		)
	);
}
...
function limbenet_register_pattern_categories() {
	register_block_pattern_category(
		'limbenet-layout',
		array( 'label' => __( 'Limbe.Net Layouts', 'limbenet' ) )
	);

	register_block_pattern_category(
		'limbenet-sections',
		array( 'label' => __( 'Limbe.Net Sections', 'limbenet' ) )
	);
}
